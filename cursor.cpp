...
UserCursor::UserCursor(SimplyNumbers *simplyGen, Hashtable *movesHash,
                 bool *swapXp, bool *swapYp, bool *swapWp) : Cursor(simplyGen, movesHash) {
        swapX = swapXp;
        swapY = swapYp;
        swapW = swapWp;
};

bool UserCursor::put(TMove N) {
                int x = N%fsize - 7;
                int y = N/fsize - 7;
